...
//en az 1 tane "R" ile biten eleman olup olmadığını kontrol etmek için bir metod oluşturun.
    public static void ebikGabık(List<String> l) {
        ...
        System.out.println();
        boolean result3= l.stream().anyMatch(t->t.endsWith("R"));System.out.println("elemanlardan herhangi biri R ile bitiyormu "+result3);
    ...
    public static void sondanIkinciSiralaIlk(List<String> l) {
        ...
        //elemanları uzunluklarına göre tersten sıralayıp  ilk elemanı yazdı
